<template>
    <header class="flex justify-between items-center h-12 p-4 shadow bg-white h-16">
        ...
        <Menu as="div" class="relative inline-block text-left">
                <MenuButton class="flex items-center">
                    <img src="https://randomuser.me/api/portraits/men/54.jpg" alt="" class="rounded-full w-8 mr-2">
